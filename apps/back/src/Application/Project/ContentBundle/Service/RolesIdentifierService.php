...
class RolesIdentifierService extends AbstractController
{
    ...
    public function getSuperAdminRole(): array
    {
        return [
            "groupName" => "Super Administrador",
            "description" => "Tem Acesso a todos os Módulos Administrativos.",
            "routes" => [[
                "routerName" => "AllActions",
    ...
    public function getSuperApiRole(): array
    {
        return [
            "groupName" => "Super Administrador API",
    ...
    public function getAdminGroupRoles(): array
    {
        ...
        return array_merge([$this->getSuperAdminRole()], $this->getGroupRoles('AdminController'));
    }
    ...
    public function getApiGroupRoles(): array
    {
        ...
        return array_merge([$this->getSuperApiRole()], $this->getGroupRoles('ApiController'));
    }
    ...
    {
        return [
            'adminRoles' => array_merge([$this->getSuperAdminRole()], $this->getGroupRoles('AdminController')),
            'apiRoles' => array_merge([$this->getSuperApiRole()], $this->getGroupRoles('ApiController')),
        ];
    }
