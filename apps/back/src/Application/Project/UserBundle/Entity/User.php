...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: "user", targetEntity: "App\Entity\Diagram")]
    private mixed $diagram;

    #[ORM\OneToMany(mappedBy: "user", targetEntity: "App\Entity\Application")]
     ...
     */
    public function getDiagram(): ArrayCollection
    {
        return $this->diagram;
    }

    /**
     * @param ArrayCollection $diagram
     */
    public function setDiagram(ArrayCollection $diagram): void
    {
