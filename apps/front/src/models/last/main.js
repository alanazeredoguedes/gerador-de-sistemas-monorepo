...
import DiagramDefinition from './_diagramStructure'

import {Project, Model, Attributes, Methods, Relationships, AssociativeModel} from './object'
...
const diagramDefinition = new DiagramDefinition([model1, model2, associativeModel], linksModels)
//const diagramDefinition = new DiagramDefinition(modelsDefault2, linksModels)
//const diagramDefinition = new DiagramDefinition([], [])

//const Diagram = diagramDefinition.diagram
